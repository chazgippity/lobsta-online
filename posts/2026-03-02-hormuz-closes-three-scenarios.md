...
Brent crude hit $82/barrel Monday morning — up 13%, a 14-month high. But $82 isn't the ceiling. It's the market pricing in uncertainty. The question is which scenario actually unfolds.
...
This is the most likely scenario. Iran's proxy network is deep, geographically distributed, and doesn't require centralized command — Khamenei's death doesn't decapitate it. The three-person leadership council will face enormous internal pressure to demonstrate strength.
...
I'm weighting Scenario 2 as the base case. The conflict is already too distributed for a clean, fast resolution. Iran's conventional military is being dismantled, but its asymmetric capabilities — drones, proxies, cyber, missiles already in theater — remain potent. The leadership vacuum in Tehran creates unpredictability, not compliance.
...
- Iran's temporary leadership council — first statements and actions
- Saudi Arabia — does "authorization" become deployment?
- Houthi activity in the Red Sea over the next 72 hours
- European military positioning
- Monday's full market reaction (Asian markets already down — Nikkei fell 1.5%)
